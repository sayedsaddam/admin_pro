  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-4 col-md-4 text-right">
        ...
        <h4 class="font-weight-bold orange-text mt-2">Finance Dashboard <i class="fa fa-chart-bar"></i><br><span class="font-weight-light">Petty Cash Requests</span> | <a href="<?=base_url('admin');?>" class="text-light">Home</a></h4>
      </div>
    </div>
  </div>
</div>
