			...
			<div class="col-6">
				<div class="card card-list">
					<div class="card-header white d-flex justify-content-between align-items-center py-3">
						<p class="h5-responsive font-weight-bold mb-0">Leaves Requests, <small>pending for director's approval.</small> | <small><a href="javascript:history.go(-1)" class="grey-text"><i class="fa fa-angle-left"></i> Back</a></small></p>
					...
					<div class="card-footer white py-3 d-flex justify-content-end">
						<a href="<?= base_url('director/get_all_leaves'); ?>" class="btn btn-outline-primary btn-md">View All</a>
					</div>
				</div>
			</div>
			<div class="col-6">
				<div class="card card-list">
					<div class="card-header white d-flex justify-content-between align-items-center py-3">
						<p class="h5-responsive font-weight-bold mb-0">Travel Requests, <small>pending for director's approval.</small> | <small><a href="javascript:history.go(-1)" class="grey-text"><i class="fa fa-angle-left"></i> Back</a></small></p>
						<ul class="list-unstyled d-flex align-items-center mb-0">
							<li><i class="far fa-window-minimize fa-sm pl-3"></i></li>
							<li><i class="fas fa-times fa-sm pl-3"></i></li>
						</ul>
						...
						<table class="table table-sm">
							...
							<?php if(!empty($travels)): foreach($travels as $travel): ?>
								<tr>
									...
									<td>
										<?php if($travel->travel_status == 1){ echo "<span class='badge badge-warning'>pending</span>"; }elseif($travel->travel_status == 2){ echo "<span class='badge badge-success'>approved</span>"; }else{ echo "<span class='badge badge-danger'>rejected</span>"; } ?>
									</td>
									<td><?= date('M d, Y', strtotime($travel->created_at)); ?></td>
									<td>
										<a href="<?= base_url('director/approve_travel/'.$travel->id); ?>" class="badge badge-primary" title="Approve request..." onclick="javascript: return confirm('Are you sure to perform this action?');"><i class="fa fa-check"></i></a>
										<a href="<?= base_url('director/reject_travel/'.$travel->id); ?>" class="badge badge-danger" title="Reject request..." onclick="javascript: return confirm('Are you sure to perform this action?');"><i class="fa fa-times"></i></a>
									</td>
								</tr>
            ...
            <div class="col-md-12">
                ...
                <form action="<?= base_url('director/approve_leave'); ?>" method="post">
                    ...
                    <div class="form-group">
                        <label for="remarks">Director's Remarks</label>
