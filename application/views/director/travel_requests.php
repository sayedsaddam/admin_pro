  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-4 col-md-4 text-right">
        ...
        <h4 class="font-weight-bold orange-text mt-2">Employee Dashboard <i class="fa fa-chart-bar"></i><br><span class="font-weight-light">Travel Requests</span> | <a href="<?=base_url('users');?>" class="text-light">Home</a></h4>
      </div>
    </div>
  </div>
</div>
					...
					<table class="table table-sm">
						...
						<?php if(!empty($travels)): foreach($travels as $travel): ?>
							<tr>
								...
								<td>
									<?php if($travel->travel_status == 1){ echo '<span class="badge badge-warning" title="pending for director\'s approval">pending</span>'; }elseif($travel->travel_status == 2){ echo "<span class='badge badge-success'>approved</span>"; }else{ echo "<span class='badge badge-danger'>rejected</span>"; } ?>
								</td>
