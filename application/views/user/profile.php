  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-lg-4 col-md-4 text-right">
        ...
        <h4 class="font-weight-bold orange-text mt-2">Profile <i class="fa fa-user"></i> <a href="<?= base_url('users'); ?>" class="text-light">Home</a></h4>
      </div>
    </div>
  </div>
</div>
        ...
        <div class="col-md-7">
            ...
            <h5 class="card-header morpheus-den-gradient white-text text-center py-4">
                ...
                <div class="card-body px-lg-5 pt-0">
                    <form class="text-center" style="color: #757575;" action="<?= base_url('users/update_profile'); ?>" method="post">
                        <input type="hidden" name="user_id" value="<?= $profile->id; ?>">
                        <div class="form-row">
                            <div class="col">
                                <div class="md-form">
                                    <input name="fullname" type="text" id="materialRegisterFormFirstName" class="form-control">
                        ...
                        <div class="md-form">
                            <input name="password" type="password" id="materialRegisterFormPassword" class="form-control">
                            <label for="materialRegisterFormPassword">Password</label>
                            <small class="deep-orange-text">Enter your existing password if you're not updating your password.</small>
                        </div>
                        <button class="btn btn-outline-info my-4 waves-effect z-depth-0" type="submit">Update</button>
