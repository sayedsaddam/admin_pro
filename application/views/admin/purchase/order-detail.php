    ...
    <?php endif; ?>
         ...
         <thead> 
          ...
          <tr>
              ...
              <!-- Button -->
              <?php if($count < 3) { ?>
              <a data-toggle="modal"  data-target="#add_qutation" class="btn btn-outline-info d-print-none"><i class="fa fa-plus"></i> Add New</a>
              <?php } else { ?>
              <h3 class="text-danger d-print-none">Quotation range is completed</h3>
              <a data-toggle="modal" data-target="#add_qutation" class="btn btn-outline-danger disabled d-print-none"><i class="fa fa-plus"></i> Add New</a>

              <?php } ?>
              <a href="#" class="btn btn-primary d-print-none" onclick="javascript:window.print();"><i class="fa fa-print"></i> Print</a>
              <a href="<?= base_url('Purchase/purchase_order_list'); ?>" class="btn btn-outline-danger d-print-none"><i class="fa fa-angle-left"></i> back</a>
