						...
						<div class="tile is-parent">
							<div class="tile is-child box">
								...
								<div class="columns">
									...
									<div class="column">
										<div class="field">
											<label class="label is-small">Name <span
													class="has-text-danger">*</span></label>
											<div class="control has-icons-left">
												<input type="text" name="name" id="" class="input is-small"
													value="<?= ucwords($edit->name) ?>" type="text"
								...
								<div class="columns">
									...
									<div class="column">
										<div class="control">
											<label class="label is-small">Phone No <span
													class="has-text-danger">*</span></label>
											<div class="control has-icons-left">
												<input type="text" name="phone" id="" class="input is-small"
													value="<?= $edit->phone ?>" type="text"
								...
								<div class="columns">
									<div class="column">
										<div class="control">
											<label class="label is-small">Catergory <span
													class="has-text-danger">*</span></label>
											<div class="control has-icons-left">
												<span class="select is-small is-fullwidth">
								...
								<div class="columns">
									<div class="column">
										<div class="control">
											<label class="label is-small">Rating <span
													class="has-text-danger">*</span></label>
											<div class="control has-icons-left">
												<input type="number" name="rating" class="input is-small" min="1"
													max="5" type="text" placeholder="1-5" value="<?= $edit->rating ?>"
													required>
												<span class="icon is-small is-left">
									...
									<div class="column">
										<fieldset>
											<div class="field">
												<label class="label is-small">Address <span
														class="has-text-danger">*</span></label>
												<div class="control has-icons-left">
							...
							<div class="buttons is-pulled-right">
								...
								<p class="control">
									<button class="button is-small is-success" type="submit"
										<?= $SuppliersAccess->update != 1 ? 'disabled' : '' ?>>
