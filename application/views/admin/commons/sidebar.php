<aside class="section is-narrow-mobile is-hidden-mobile" id="categories">
	...
	<ul class="menu-list">
		<li><a class="<?= $this->uri->segment(2) == 'get_assign_item' || $this->uri->segment(2) == 'available_item_list' || $this->uri->segment(2) == 'item_register' || $this->uri->segment(2) == 'product_report' || $this->uri->segment(2) == 'add_item' || $this->uri->segment(2) == 'search_item' || $this->uri->segment(2) == 'item_detail' || $this->uri->segment(2) == 'assign_item' || $this->uri->segment(2) == 'get_damaged_item' ? 'is-primary has-text-weight-bold is-inverted' : '' ?> nav-category"
				<?= $this->uri->segment(2) == 'get_assign_item' || $this->uri->segment(2) == 'available_item_list' || $this->uri->segment(2) == 'item_register' || $this->uri->segment(2) == 'product_report' || $this->uri->segment(2) == 'add_item' || $this->uri->segment(2) == 'search_item' || $this->uri->segment(2) == 'item_detail' || $this->uri->segment(2) == 'assign_item' || $this->uri->segment(2) == 'get_damaged_item' ? 'style="background-color:#ebfffc;"' : '' ?>>Item
				Register</a>
			<ul class="sub-categories"
				style="<?= $this->uri->segment(2) == 'get_assign_item' || $this->uri->segment(2) == 'available_item_list' || $this->uri->segment(2) == 'item_register' || $this->uri->segment(2) == 'product_report' || $this->uri->segment(2) == 'add_item' || $this->uri->segment(2) == 'search_item' || $this->uri->segment(2) == 'item_detail' || $this->uri->segment(2) == 'assign_item' || $this->uri->segment(2) == 'get_damaged_item' ? '' : 'display: none;' ?>">
				...
				<li class="is-size-7 <?= $this->uri->segment(2) == 'get_damaged_item' ? 'has-text-weight-bold' : '' ?>"><a href="<?= base_url('admin/get_damaged_item'); ?>"><i
							class="fas fa-bars mr-1"></i> Damaged List</a></li>
