												...
												<div class="control has-icons-left">
													<span class="select is-small is-fullwidth">
														...
														<select name="sub_categories" id="sub_categories" required>
															<option selected disabled value="">Select a Sub Categories
															</option>
											...
											<div class="select is-small is-fullwidth">
												<div class="control has-icons-left">
													<input type="number" name="quantity" id="" class="input is-small"
														value="<?php if(!empty($edit)){ echo $edit->quantity; } ?>"
														type="text" placeholder="1-99" required="">
													<span class="icon is-small is-left">
											...
											<div class="select is-small is-fullwidth">
												<div class="control has-icons-left">
													<input type="number" name="price" id="" class="input is-small"
														value="<?php if(!empty($edit)){ echo $edit->price; } ?>"
														type="text" placeholder="1-9,999,999" required="">
													<span class="icon is-small is-left">
									...
									<div class="column">
										<div class="control">
											...
											<div class="is-small is-fullwidth">
												<div class="control has-icons-left">
													<?php if(!empty($edit)){$date = strtotime($edit->purchase_date); $purchase_date = date('Y-m-d', $date); }?>
									...
									<div class="column">
										<fieldset>
											<div class="field">
												...
												<div class="control has-icons-left">
													<textarea class="textarea is-small" name="description" rows="2"
														id=""
			...
			$.ajax({
				...
				success: function (response) {
					...
					$.each(response, function (index, data) {
						$('#sub_categories').append('<option value="' + data['id'] +
							'">' + data['name'] + '</option>');
					});
				}
			});
