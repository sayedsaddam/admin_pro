						...
						<table class="table table-sm is-fullwidth">
							...
							<tbody id="myTable">
								...
								<tr>
									...
									<td class="is-narrow">
										<a data-id="<?= $sup->emp_id; ?>" class="supplier_info button is-small"><span
							...
							<tbody id="myTable">
								...
								<tr>
									...
									<td class="is-narrow">
										<a data-id="<?= $res->id; ?>" class="supplier_info button is-small"><span class="icon is-small"><i
			...
			<section class="modal-card-body">
				<div class="columns">
					<div class="column">
						<fieldset>
							<div class="field">
								<label class="label is-small">User Name <span class="has-text-danger">*</span></label>
								<div class="control has-icons-left">
									<input type="text" name="user_name" id="" class="input is-small" value="" type="text"
					...
					<div class="column">
						<fieldset>
							<div class="field">
								<label class="label is-small">Full Name <span class="has-text-danger">*</span></label>
								<div class="control has-icons-left">
									<input type="text" name="full_name" id="" class="input is-small" value="" type="text"
			...
			<section class="modal-card-body">
					...
					<div class="column">
						<fieldset>
							<div class="field">
								<label class="label is-small">Full Name <span class="has-text-danger">*</span></label>
								<div class="control has-icons-left">
									<input type="text" name="full_name" id="f_name" class="input is-small" value=""> 
									<span class="icon is-small is-left">
										<i class="fas fa-user"></i>
									</span>
								</div>
				...
				<div class="columns">
					<div class="column">
						<div class="control">
							<label class="label is-small">Phone No <span class="has-text-danger">*</span></label>
							<div class="is-small is-fullwidth">
								<input type="text" name="phone" id="phone" class="input is-small" value=""
									required="">
				...
				<div class="columns">
					...
					<div class="column">
						<label class="label is-small">DOB <span class="has-text-danger">*</span></label>
						<div class="is-small is-fullwidth">
							<input type="date" name="dob" id="dob" class="input is-small" value="" required="">
          ...
          <div class="column">
						<fieldset>
							<div class="field">
								<label class="label is-small">Address</label>
								<div class="control has-icons-left">
									<textarea class="textarea is-small" name="employ_address" rows="1" value="" id="employ_address"
										placeholder="some detail"></textarea>
								</div>
							</div>
						</fieldset>
