  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-4 col-md-4 text-right">
        ...
        <h4 class="font-weight-bold orange-text mt-2">Admin Dashboard <i class="fa fa-chart-bar"></i><br><span class="font-weight-light orange-text">Approved Requests</span></h4>
      </div>
    </div>
  </div>
</div>
