	...
	<section>
		<div class="row">
			<div class="col-lg-12 col-md-8 text-right">
				<a href="javascript:exportTableToExcel('items','Item  Records');"
					class="btn btn-outline-dark btn-sm d-print-none">Export</a>
				<a href="javascript:history.go(-1)" class="btn btn-outline-danger btn-sm d-print-none"><i
