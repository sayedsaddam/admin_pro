							...
							<div class="tile is-child box">
												...
												<div class="control has-icons-left">
													<span class="select is-small is-fullwidth">
														<select name="location" id="supplier_location" required
															...
															<option value="<?= $loc->id; ?>"
																<?php !empty($edit) && $edit->id == $loc->id ? 'selected' : '' ?>>
																<?= ucwords($loc->name); ?>
															</option>
								...
								<div class="columns">
									...
									<div class="column">
										<fieldset>
											<div class="field">
												<label class="label is-small">Supplier <span
														class="has-text-danger">*</span></label>
												<div class="control has-icons-left">
													<span class="select is-small is-fullwidth">
								...
								<div class="columns">
									...
									<div class="column">
										<fieldset>
											<div class="field">
												<label class="label is-small">Subcategory <span
														class="has-text-danger">*</span></label>
												<div class="control has-icons-left">
													<span class="select is-small is-fullwidth">
														<select name="sub_category" id="item_name" required
															<?= isset($edit) ? 'disabled' : '' ?>>
															<option selected disabled value="">Select a Subcategory
															</option>
									...
									<div class="column">
										<label class="label is-small">Project / Company <span
												class="has-text-danger">*</span></label>
										<div class="select select is-small is-fullwidth">
								...
								<div class="columns">
									<div class="column">
										<fieldset>
											<div class="field">
												<label class="label is-small">Item Company <span
														class="has-text-danger">*</span></label>
												<div class="control has-icons-left">
													<input name="item_name" id="sub_item_name"
														value="<?= !empty($edit) ? ucwords($edit->type_name) : '' ?>"
														class="input is-small" type="text" placeholder="e.g Apple"
														required>
													<span class="icon is-small is-left">
									...
									<div class="column">
										<fieldset>
											<div class="field">
												<label class="label is-small">Quantity <span
														class="has-text-danger">*</span></label>
												<div class="control has-icons-left">
													<input name="quantity" id="item-quantity"
														value="<?= !empty($edit) ? $edit->quantity : '1'; ?>"
														class="input is-small" type="number" min="1" max="99"
								...
								<div class="columns">
									...
									<div class="column">
										<fieldset>
											<div class="field">
												<label class="label is-small">Model <span
														class="has-text-danger">*</span></label>
												<div class="control has-icons-left">
													<input name="model"
														value="<?= !empty($edit) ? ucwords($edit->model) : '' ?>"
														class="input is-small" type="text" placeholder="e.g 110 4G"
														required>
													<span class="icon is-small is-left">
									...
									<div class="column">
										<fieldset>
											<div class="field">
												<label class="label is-small">Serial Number / IMEI <span
														class="has-text-danger" id="serial-required"
														style="display:none;">*</span></label>
												<div class="control has-icons-left">
													<input name="serial_number"
														value="<?= !empty($edit) ? $edit->serial_number : '' ?>"
														class="input is-small" id="serial-number" type="text"
														placeholder="e.g X12X34Y5XYXY">
													<span class="icon is-small is-left">
								...
								<div class="columns">
									...
									<div class="column">
										<fieldset>
											<div class="field">
												<label class="label is-small">Price (PKR) <span
														class="has-text-danger">*</span></label>
												<div class="control has-icons-left">
													<input name="price" value="<?= !empty($edit) ? $edit->price : '' ?>"
														class="input is-small" type="number" min="1" max="9999999"
									...
									<div class="column">
										<fieldset>
											<div class="field">
												<label class="label is-small">Depreciation (%) <span
														class="has-text-danger">*</span></label>
												<div class="control has-icons-left">
													<span class="select is-small is-fullwidth">
														<select name="depreciation" id="depreciation" required>
															...
															<option disabled value=""
																<?php if(!isset($edit_item)){ echo 'selected'; } ?>>
																Select a Value
															</option>
															<option value="5"
								...
								<div class="columns">
									...
									<div class="column">
										<fieldset>
											<div class="field">
												<label class="label is-small">Status <span
														class="has-text-danger">*</span></label>
												<div class="control has-icons-left">
													<span class="select is-small is-fullwidth">
														<select name="status" id="status" required>
															...
															<option value="<?= $stat->id; ?>"
																<?= !empty($edit) && $edit->status == $stat->id ? 'selected' : '' ?>>
																<?= $stat->type; ?>
															</option>
															<?php endforeach; endif; ?>
														</select>
					...
					<div class="columns">
						<div class="column has-text-right">
							<div class="buttons is-pulled-right">
								...
								<button class="button is-danger is-small is-outlined" type="reset">Reset
									Form</button>
								<?php endif ?>
								<p class="control">
...
<script>
	...
	$(document).ready(function () {
		...
		$('#supplier_location').on('change', function () {
			...
			$.ajax({
				url: '<?=base_url('
				admin / supplier_against_location / ')?>' + location,
				method: 'post',
				data: {
					location: location
				},
				...
				success: function (response) {
					...
					// Add options
					$.each(response, function (index, data) {
						$('#supplier').append('<option value="' + data['id'] + '">' +
							data['name'] + '</option>');
						$('#supplier_email').append('<option value="' + data['id'] +
							'">' + data['email'] + '</option>');
					});
				}
			});
