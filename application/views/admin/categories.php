		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-4 text-right">
				...
				<h4 class="font-weight-bold orange-text mt-2">Admin Dashboard <i class="fa fa-chart-bar"></i><br><span
						class="font-weight-light orange-text"><?php if(empty($results)){ echo 'Categories'; }else{ echo 'Search Results'; } ?>
...
<div class="container">
	...
	<div class="row mb-4">
		...
		<div class="col-lg-6 col-md-6 text-right">
			<button data-toggle="modal" data-target="#add_inventory" class="btn btn-outline-info"><i class="fa fa-plus"></i>
				Add New</button>
		...
		<div class="col-lg-12 col-md-12">
			<table class="table table-sm">
				...
				<tbody>
					...
					<tr>
						<td><?= 'AHG-0'.$cat->id; ?></td>
						<td><a href="<?= base_url('admin/sub_categories/'.$cat->id); ?>"
								class="text-info"><?= $cat->cat_name; ?></a></td>
						<td><?= ucfirst($cat->name); ?></td>
						<td><?= $cat->fullname; ?></td>
						<td><?= date('M d, Y', strtotime($cat->created_at)); ?></td>
						<td>
							<a title="Edit" data-id="<?= $cat->id; ?>" class="category"><span class="badge badge-primary"><i
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a title="Edit" data-id="<?= $res->id; ?>" class="category"><span class="badge badge-primary"><i
										class="fa fa-edit"></i></span></a>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer d-flex justify-content-right">
				<button class="btn btn-unique" data-dismiss="modal" aria-label="Close">Close <i
